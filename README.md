...
```
cd existing_repo
git remote add origin https://gitlab.com/quanrio/earnscape-stream.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/quanrio/earnscape-stream/-/settings/integrations)
